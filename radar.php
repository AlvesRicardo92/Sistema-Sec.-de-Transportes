...
<body>
    ...
    <div class="container col-md-10">
        <h2 style="text-align: center;">Pesquisa Domiciliar</h2>
        <form action="" method="post" id="formulario" name="formulario">
            ...
            <div class="row mb-3 mt-3">
                <div class="form-floating col-md-12">
                    <textarea class="form-control" id="desc" placeholder="&nbsp;&nbsp; Descrição"
            ...
            <div class="row">
                ...
                <div class="row">
                    <div class="col-md-12 mt-3 mb-5 text-center">
                        <button type="button" id="salvar" class="btn btn-primary" onclick="enviarPD()"
                            disabled>Salvar</button>
                        <button type="button" id="imprimir" class="btn btn-primary" onclick="imprimirPD()"
