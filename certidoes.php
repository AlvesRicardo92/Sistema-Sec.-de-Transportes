...
<body>
    ...
    <div class="container col-md-10">
        <h2 style="text-align: center;">Certidões</h2>
        <form action="" method="post" id="formulario" name="formulario">
            <div class="mt-5">
                <div class="row">

                    <div class="col-md-10 mb-2">
                        <button type="button" class="btn btn-primary" onclick="gerarNovoce()" id="novo">Novo</button>
                ...
                <div class="row">
                    <div class="col-md-3 mb-3 mt-3">
                        <label for="diariaNumero" class="form-label">Certidão Nº</label>
                        <input type="text" class="form-control" id="ceNumero" placeholder="Nº" disabled>
                    </div>
                    <div class="col-md-3 mt-3">
                        <label for="diariaData" class="form-label">Data</label>
                        <input type="date" class="form-control" id="ceData" disabled>
                    </div>
                </div>
                <div class="row">
                ...
                <div class="row">
                    <div class="col-md-12 mb-3">
                        ...
                        <input type="text" class="form-control" id="documento" placeholder="Documento" disabled>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-12 mb-3">
                        <label for="interessado" class="form-label">Interessado</label>
                        <input type="text" class="form-control" id="interessado" placeholder="Interessado" disabled>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-12">
