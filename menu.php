                ...
                <ul class="nav nav-pills flex-column mb-sm-auto mb-0 align-items-center align-items-sm-start" id="menu">
                    ...
                    <li class="nav-item">
                        <a href="semaforica.php" class="nav-link align-middle px-0">
                            <i class="bi bi-stoplights"></i>&nbsp;&nbsp;<span
                                class="ms-1 d-none d-sm-inline">Semafórica</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="carros.php" class="nav-link align-middle px-0">
                            <i class="bi bi-speedometer2"></i>&nbsp;&nbsp;<span
                                class="ms-1 d-none d-sm-inline">Carros</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="projeto.php" class="nav-link align-middle px-0">
                            <i class="bi bi-cone-striped"></i>&nbsp;&nbsp;<span
                                class="ms-1 d-none d-sm-inline">Projeto</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="oficio.php" class="nav-link align-middle px-0">
                            <i class="bi bi-file-earmark-check"></i>&nbsp;&nbsp;<span
                                class="ms-1 d-none d-sm-inline">Oficios</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="certidoes.php" class="nav-link align-middle px-0">
                            <i class="bi bi-globe2"></i>&nbsp;&nbsp;<span
                                class="ms-1 d-none d-sm-inline">Certidões</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="cadastroOS.php" class="nav-link align-middle px-0">
                            <i class="bi bi-play-btn"></i>&nbsp;&nbsp;<span class="ms-1 d-none d-sm-inline">Cadastro
                                O.S.</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="controleOS.php" class="nav-link align-middle px-0">
                            <i class="bi bi-amd"></i>&nbsp;&nbsp;<span class="ms-1 d-none d-sm-inline">Controle de
                                O.S.</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="controleImplantacao.php" class="nav-link align-middle px-0">
                            <i class="bi bi-recycle"></i>&nbsp;&nbsp;<span class="ms-1 d-none d-sm-inline">Cont. de
                                Implantações</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="radar.php" class="nav-link align-middle px-0">
                            <i class="bi bi-pin-map-fill"></i>&nbsp;&nbsp;<span class="ms-1 d-none d-sm-inline">Radar e
                                Estatistica</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="" class="nav-link align-middle px-0">
                            <i class="bi bi-pencil"></i>&nbsp;&nbsp;<span
                                class="ms-1 d-none d-sm-inline">Relatórios</span>
                        </a>
                    </li>
                </ul>
                <hr>
