							...
							<div id="myCarousel" class="carousel slide" data-bs-ride="carousel">
								...
								<div class="carousel-inner">
									...
									<div class="carousel-item" style="height:300px">
										<svg class="bd-placeholder-img" width="100%" height="100%" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" preserveAspectRatio="xMidYMid slice" focusable="false"><rect width="100%" height="100%" fill="#555"/></svg>
										<div class="container">
											<div class="carousel-caption"> <!-- Alinhamento do conteúdo do slide centralizado sem qualquer classe text-xxx -->
									...
									<div class="carousel-item" style="height:300px">
										...
										<div class="container">
											<div class="carousel-caption text-end"><!-- Alinhamento do conteúdo do slide à direita text-end -->
									...
									<div class="carousel-item" style="height:300px">
										<svg class="bd-placeholder-img" width="100%" height="100%" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" preserveAspectRatio="xMidYMid slice" focusable="false"><rect width="100%" height="100%" fill="#af1"/></svg>
										<div class="container">
											<div class="carousel-caption text-end">
												<h1>quarto slide</h1>
												<p>Some representative placeholder content for the third slide of this carousel.Some representative placeholder content for the third slide of this carousel.Some representative placeholder content for the third slide of this carousel.</p>
												<p><a class="btn btn-lg btn-primary" href="#">Browse gallery</a></p>
											</div>
										</div>
									</div>
