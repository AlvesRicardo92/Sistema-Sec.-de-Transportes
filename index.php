...
<head>
    ...
    <title>Sistema de controle - ST</title>
    <!-- Favicon-->
            ...
            <div class="mt-5">
                <div class="row">
                    <div class="col-md-12 mb-2">
                        <button type="button" class="btn btn-primary" onclick="gerarNovo()" id="novo"
                            disabled>Novo</button>
                        <button type="button" class="btn btn-primary" id="pesquisar" data-bs-toggle="modal"
                            data-bs-target="#pesquisaDiaria" disabled>Pesquisar</button>
                    </div>
                </div>
                <div class="row">
                ...
                <div class="row">
                    <div class="col-md-12 mb-3">
                        ...
                        <input type="text" class="form-control" id="responsavel"
                            placeholder="Nome do funcionário que está cadastrando a Diária" disabled>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-12">
                        <button type="button" class="btn btn-primary" id="buscaEndereco" data-bs-toggle="modal"
                            data-bs-target="#staticBackdrop" onclick="passaChamada('L1')" disabled>Digitar
                            endereço</button>
                    </div>
                </div>
                <div class="row">
                ...
                <div class="row">
                    <div class="col-md-2">
                        <button type="button" class="btn btn-primary" style="margin-top:25px;"
                            id="buscaEnderecoCruzamento" data-bs-toggle="modal" data-bs-target="#staticBackdrop"
                            onclick="passaChamada('L2')" disabled>Digitar cruzamento</button>
                    </div>
                    <div class="col-md-10">
                        <label for="logradouroCruzamento" class="form-label">Logradouro do Cruzamento</label>
                        <input type="text" class="form-control" id="logradouroCruzamento"
                            placeholder="Logradouro do Cruzamento" disabled>
                    </div>
                </div>
                <div class="row mb-3 mt-2">
                    <div class="form-floating">
                        <textarea class="form-control" id="ocorrencia" placeholder="&nbsp;&nbsp;Descrição da ocorrência"
                ...
                <div class="row">
                    ...
                    <div class="col-md-1 mt-2">
                        <button class="btn btn-primary" type="button" id="incluirNaLista"
                            style="border-top-right-radius: 0.3rem;border-bottom-right-radius: 0.3rem;"
                            onclick="inserirLinhaTabela(document.getElementById('tipoAtividade').selectedOptions[0].innerText)"
                ...
                <div class="row">
                    ...
                    <div class="col-md-3 mb-3" style="padding-top:9px;">
                        <input type="text" class="form-control" placeholder="Quantidade" aria-label="Quantidade"
                            aria-describedby="incluirNaListaMaterial" id="quantidadeMaterial" disabled>
                    </div>
                    <div class="col-md-4 mb-3">
                        <div style="padding-top:15px;">&nbsp;&nbsp;
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="origemMaterial" id="retirada"
                                    value="Retirada" disabled>
                                <label class="form-check-label" for="retirada">Retirada</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="origemMaterial" id="pmsbc"
                                    value="PMSBC" disabled>
                                <label class="form-check-label" for="pmsbc">PMSBC</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="origemMaterial" id="consorcio"
                                    value="Consórcio" disabled>
                                <label class="form-check-label" for="consorcio">Consórcio</label>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-1 mt-2">
                        <button class="btn btn-primary" type="button" id="incluirNaListaMaterial"
                            style="border-top-right-radius: 0.3rem;border-bottom-right-radius: 0.3rem;"
                            onclick="inserirLinhaTabelaMaterial(document.getElementById('tipoMaterial').selectedOptions[0].innerText,document.getElementById('quantidadeMaterial').value)"
                            disabled>Incluir</button>
                    </div>
                ...
                <div class="row">
                    <div class="col-md-12 mt-3 mb-5 text-center">
                        <button type="button" id="salvar" class="btn btn-primary" onclick="enviarForm()"
